...
public class MailMessage {
	public static void registrationSuccess(String emailId, String name) {
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				+ "<h2 style='color:green;'>Welcome to Gada Electronics</h2>" + "" + "Hi " + name + ","
				+ "<br><br>Thanks for singing up with Gada Electronics.<br>"
				...
				+ "to enter the promo code given below.<br><br><br> PROMO CODE: " + "GARBA500<br><br><br>"
	...
	public static void transactionSuccess(String recipientEmail, String name, String transId, double transAmount) {
		...
		String subject = "Order Placed at Gada Electronics";
		String htmlTextMessage = "<!DOCTYPE html>"
			    + "<html><body>"
			    + "<p>Hey " + name + ",<br><br>"
			    + "We are glad that you shop with Gada Electronics!<br><br>"
			    + "Your order has been placed successfully and is being processed for shipment."
			    + "<br><h6>Please Note that this is a demo project Email and you have not made any real transaction with us!</h6><br>"
			    + "Here are your transaction details:<br><br>"
			    + "<span style='color:red;font-weight:bold;'>Order Id:</span> "
			    + "<span style='color:green;font-weight:bold;'>" + transId + "</span><br><br>"
			    + "<span style='color:red;font-weight:bold;'>Amount Paid:</span> "
			    + "<span style='color:green;font-weight:bold;'>" + transAmount + "</span><br><br>"
			    + "Thanks for shopping with us!<br><br>"
			    + "Come shop again!<br><br>"
			    + "<span style='color:green;font-weight:bold;'>Gada Electronics.</span>"
			    + "</p></body></html>";
	...
	public static void orderShipped(String recipientEmail, String name, String transId, double transAmount) {
		String recipient = recipientEmail;
		String subject = "Hurray!!, Your Order has been Shipped from Gada Electronics";
		String htmlTextMessage = "<!DOCTYPE html>"
			    + "<html><body><p>"
			    + "Hey " + name + ",<br/><br/>"
			    + "We are glad that you shop with Gada Electronics!<br/><br/>"
			    + "Your order has been shipped successfully and is on the way to be delivered.<br/>"
			    + "<h6>Please Note that this is a demo project Email and you have not made any real transaction with us till now!</h6><br/>"
			    + "Here are your transaction details:<br/><br/>"
			    + "<span style=\"color:red;font-weight:bold;\">Order Id:</span> "
			    + "<span style=\"color:green;font-weight:bold;\">" + transId + "</span><br/><br/>"
			    + "<span style=\"color:red;font-weight:bold;\">Amount Paid:</span> "
	...
	public static void productAvailableNow(String recipientEmail, String name, String prodName, String prodId) {
		String recipient = recipientEmail;
		String subject = "Product " + prodName + " is Now Available at Gada Electronics";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				...
				+ "      Come Shop Again! <br/<br/><br/> <font style=\"color:green;font-weight:bold;\">Gada Electronics.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
